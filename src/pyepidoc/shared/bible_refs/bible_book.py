...
NT_BOOKS: dict[Bk, list[str]] = {
    ...
    Bk.Ph:      ['11', 'ph', 'phil', 'philippians'],
    Bk.Co:      ['12', 'co', 'col', 'colossians'],
    ...
    Bk.IJn:     ['23', '1jn', 'ijn', '1john', 'ijohn'],
    Bk.IIJn:    ['24', '2jn', 'iijn', '2john', 'iijohn'],
    Bk.IIIJn:   ['25', '3jn', 'iiijn', '3john', 'iiijohn'],
    Bk.Ju:      ['26', 'jude', 'jud'],
