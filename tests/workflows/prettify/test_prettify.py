...
relative_filepaths = {
    'ugly': 'tests/workflows/prettify/files/input/ISic000552.xml',
    'benchmark_lxml': 'tests/workflows/prettify/files/benchmark/ISic000552_prettified_lxml.xml',
    'benchmark_pyepidoc': 'tests/workflows/prettify/files/benchmark/ISic000552_prettified_pyepidoc.xml',
    'prettified_lxml': 'tests/workflows/prettify/files/output/ISic000552_prettified_lxml.xml',
    'prettified_pyepidoc': 'tests/workflows/prettify/files/output/ISic000552_prettified_pyepidoc.xml',
}
